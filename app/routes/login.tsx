...
import { startAuthentication } from "remix-auth-webauthn/browser";
...
export default function Login() {
  ...
  return (
    <div className="relative h-[100svh] w-full flex flex-col justify-center items-center">
      <div className="w-full h-full max-w-[360px] flex flex-col items-center justify-center">
        ...
        <div className="w-full flex justify-start">
          <Link href="/register" color="foreground" size="sm" underline="always">
            新規登録する
          </Link>
        </div>
